...
const Register = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-[#166FE5] to-[#1A73E8] px-4">
      <div className="flex flex-col md:flex-row bg-white rounded-3xl shadow-xl overflow-hidden w-full max-w-5xl">
        {/* Illustration Section */}
        <div className="hidden md:flex md:w-1/2 bg-gradient-to-b from-[#166FE5] to-[#1A73E8] flex-col items-center justify-center p-12 text-white">
          <h2 className="text-4xl font-bold mb-4">Join LibraryOS</h2>
          <p className="text-lg text-white/90 text-center">
            Create your account and get instant access to thousands of books.
            Borrow, read, and explore anytime!
          </p>
          <img
